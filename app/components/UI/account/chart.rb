class UI::Account::Chart < ApplicationComponent
  ...
  def title
    ...
    when "Investment", "Crypto"
      case view
      when "balance"
        I18n.t("accounts.chart.titles.total_account_value", default: "Total account value")
      when "holdings_balance"
    ...
    when "Property", "Vehicle"
      I18n.t(
        "accounts.chart.titles.estimated_value.#{account.accountable_type.underscore}",
        default: "Estimated #{account.accountable_type.humanize.downcase} value"
      )
    when "CreditCard", "OtherLiability"
      I18n.t("accounts.chart.titles.debt_balance", default: "Debt balance")
    when "Loan"
      I18n.t("accounts.chart.titles.remaining_principal_balance", default: "Remaining principal balance")
    else
